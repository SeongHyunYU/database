...
<html>
	<head>
		<title>Helper to be healthy</title>
		<meta charset="utf-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Intro -->
					<section class="intro">
						<header>
							<h1>Helper to be healthy</h1>
							<p>Yu seong hyun / Nam hyun jae / ha jun hyung</a></p>
							<ul class="actions">
				...
				<!-- Section -->
					<section id="first">
						...
						<div class="content">
							<p><strong>Helper to be healthy</strong> </p>
							<p>You can record the exercise you did, and record the diet you ate on the day to help you lose weight through management.</p>
							<span class="image main"><img src="images/pic2.PNG" alt="" /></span>
							<ul class="actions">
								<li><a href="#" class="button primary large">SIGN UP</a></li>
								<li><a href="#" class="button large">LOGIN</a></li>
							</ul>
						</div>
					</section>
